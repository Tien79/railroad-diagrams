...
Representing grammars is a rich field of work since 8 or 7 decades or so (the present article is written in January 2017) and many existing forms have been released so far. You can go and see articles dealing with this matter googleing or wikipediaing... Here is a list of article to learn more about that
